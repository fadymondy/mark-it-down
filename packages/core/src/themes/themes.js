...
exports.THEME_IDS = exports.THEMES = void 0;
exports.findTheme = findTheme;
exports.paletteToCss = paletteToCss;
exports.THEMES = [
    {
        id: 'github-light',
        label: 'GitHub Light',
...
exports.THEME_IDS = exports.THEMES.map(t => t.id);
function findTheme(id) {
    return exports.THEMES.find(t => t.id === id);
}
